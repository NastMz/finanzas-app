...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@finanzas/data/sqlite": resolve(currentDirectory, "packages/data/src/sqlite/index.ts"),
      ...
      "@finanzas/platform-shared/sqlite": resolve(
        currentDirectory,
        "packages/platform/platform-shared/src/sqlite-context.ts",
      ),
